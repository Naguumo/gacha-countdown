 ...
 *
 * Generated at: 2026-01-01T03:32:20.287Z
 *
 * To modify: Edit ../../styles/app.css
...
export interface DefaultTheme {
  ...
  card: { DEFAULT: 'oklch(1 0 0)'; foreground: 'oklch(0.28 0.04 260.33)' };
  popover: { DEFAULT: 'oklch(1 0 0)'; foreground: 'oklch(0.28 0.04 260.33)' };
  primary: { DEFAULT: 'oklch(0.59 0.2 277.06)'; foreground: 'oklch(1 0 0)' };
  secondary: { DEFAULT: 'oklch(0.93 0.01 261.82)'; foreground: 'oklch(0.37 0.03 259.73)' };
  muted: { DEFAULT: 'oklch(0.97 0 0)'; foreground: 'oklch(0.55 0.02 264.41)' };
  accent: { DEFAULT: 'oklch(0.93 0.03 273.66)'; foreground: 'oklch(0.37 0.03 259.73)' };
  destructive: 'oklch(0.64 0.21 25.39)';
  border: 'oklch(0.87 0.01 261.81)';
  input: 'oklch(0.87 0.01 261.81)';
  ring: 'oklch(0.59 0.2 277.06)';
  chart: { '1': 'oklch(0.59 0.2 277.06)'; '2': 'oklch(0.51 0.23 276.97)'; '3': 'oklch(0.46 0.21 277.06)'; '4': 'oklch(0.4 0.18 277.16)'; '5': 'oklch(0.36 0.14 278.65)' };
  sidebar: { DEFAULT: 'oklch(0.97 0 0)'; foreground: 'oklch(0.28 0.04 260.33)'; primary: { DEFAULT: 'oklch(0.59 0.2 277.06)'; foreground: 'oklch(1 0 0)' }; accent: { DEFAULT: 'oklch(0.93 0.03 273.66)'; foreground: 'oklch(0.37 0.03 259.73)' }; border: 'oklch(0.87 0.01 261.81)'; ring: 'oklch(0.59 0.2 277.06)' }
};
  fontSize: {
  ...
  shadows: {
  '2xs': '0px 4px 8px -1px oklch(0 0 0 / 0.05)';
  xs: '0px 4px 8px -1px oklch(0 0 0 / 0.05)';
  sm: '0px 4px 8px -1px oklch(0 0 0 / 0.1), 0px 1px 2px -2px oklch(0 0 0 / 0.1)';
  md: '0px 4px 8px -1px oklch(0 0 0 / 0.1), 0px 2px 4px -2px oklch(0 0 0 / 0.1)';
  lg: '0px 4px 8px -1px oklch(0 0 0 / 0.1), 0px 4px 6px -2px oklch(0 0 0 / 0.1)';
  xl: '0px 4px 8px -1px oklch(0 0 0 / 0.1), 0px 8px 10px -2px oklch(0 0 0 / 0.1)';
  '2xl': '0px 4px 8px -1px oklch(0 0 0 / 0.25)';
  default: '0px 4px 8px -1px oklch(0 0 0 / 0.1), 0px 1px 2px -2px oklch(0 0 0 / 0.1)';
...
export interface Dark {
  ...
  card: { DEFAULT: 'oklch(0.28 0.04 260.33)'; foreground: 'oklch(0.93 0.01 256.71)' };
  popover: { DEFAULT: 'oklch(0.28 0.04 260.33)'; foreground: 'oklch(0.93 0.01 256.71)' };
  primary: { DEFAULT: 'oklch(0.68 0.16 276.93)'; foreground: 'oklch(0.21 0.04 264.04)' };
  secondary: { DEFAULT: 'oklch(0.34 0.03 261.83)'; foreground: 'oklch(0.87 0.01 261.81)' };
  muted: { DEFAULT: 'oklch(0.28 0.04 260.33)'; foreground: 'oklch(0.71 0.02 261.33)' };
  accent: { DEFAULT: 'oklch(0.37 0.03 259.73)'; foreground: 'oklch(0.87 0.01 261.81)' };
  destructive: 'oklch(0.64 0.21 25.39)';
  border: 'oklch(0.45 0.03 257.68)';
  input: 'oklch(0.45 0.03 257.68)';
  ring: 'oklch(0.68 0.16 276.93)';
  chart: { '1': 'oklch(0.68 0.16 276.93)'; '2': 'oklch(0.59 0.2 277.06)'; '3': 'oklch(0.51 0.23 276.97)'; '4': 'oklch(0.46 0.21 277.06)'; '5': 'oklch(0.4 0.18 277.16)' };
  sidebar: { DEFAULT: 'oklch(0.28 0.04 260.33)'; foreground: 'oklch(0.93 0.01 256.71)'; primary: { DEFAULT: 'oklch(0.68 0.16 276.93)'; foreground: 'oklch(0.21 0.04 264.04)' }; accent: { DEFAULT: 'oklch(0.37 0.03 259.73)'; foreground: 'oklch(0.87 0.01 261.81)' }; border: 'oklch(0.45 0.03 257.68)'; ring: 'oklch(0.68 0.16 276.93)' }
};
  radius: {
  sm: 'calc(0.5rem - 4px)';
  md: 'calc(0.5rem - 2px)';
  ...
  xs: '0 1px 3px 0px oklch(0 0 0 / 0.05)';
  sm: '0 1px 3px 0px oklch(0 0 0 / 0.1), 0 1px 2px -1px oklch(0 0 0 / 0.1)';
  default: '0 1px 3px 0px oklch(0 0 0 / 0.1), 0 1px 2px -1px oklch(0 0 0 / 0.1)';
  md: '0 1px 3px 0px oklch(0 0 0 / 0.1), 0 2px 4px -1px oklch(0 0 0 / 0.1)';
  lg: '0 1px 3px 0px oklch(0 0 0 / 0.1), 0 4px 6px -1px oklch(0 0 0 / 0.1)';
  xl: '0 1px 3px 0px oklch(0 0 0 / 0.1), 0 8px 10px -1px oklch(0 0 0 / 0.1)';
  '2xl': '0 1px 3px 0px oklch(0 0 0 / 0.25)'
};
}
